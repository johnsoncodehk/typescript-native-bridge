...
const THROW_FILE = '/tmp/tnb-sim-a-throws.jsonl';
const OUT_JSON = '/tmp/tnb-sim-a-nav-results.json';
const OUT_LOG = '/tmp/tnb-sim-a-nav-run.log';
...
log(`files=${entries.length} ops=${ops.length} compareUnits=${compareKeys.length}`);
