...
export const CASES = {
	...
	'truncation-ellipsis-density': [
		...
		{
			title: 'vue:#4577-Row-ellipsis',
			file: twFile('component-meta/#4577/main.vue'),
			line: 10,
			offset: 34,
			vue: true,
			note: 'type-param site with ellipsis density skew',
		},
		{
			title: 'vue:generic-T-ellipsis',
		...
		{
			title: 'vue:ref-model-defineModel',
			file: twFile('component-meta/reference-type-model/component.vue'),
			line: 5,
			offset: 1,
			vue: true,
		},
		{
			title: 'vue:tsc-2048-ellipsis',
			file: twFile('tsc/#2048/main.vue'),
			line: 3,
			offset: 3,
			vue: true,
		},
		{
			title: 'ts:defineComponent-call-ellipsis',
			file: twFile('component-meta/component-name-description/component-ts.ts'),
			line: 6,
			offset: 16,
			vue: true,
	...
	'alias-expand-vs-compact': [
		...
		{
			title: 'ts:options-api-default-any',
			file: twFile('component-meta/options-api/component.ts'),
			line: 14,
			offset: 8,
			vue: true,
		},
		{
			title: 'vue:ref-exposed-default-any',
			file: twFile('component-meta/reference-type-exposed/component-options-api.vue'),
			line: 4,
			offset: 1,
			vue: true,
		},
