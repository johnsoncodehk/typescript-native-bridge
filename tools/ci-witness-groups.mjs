		...
		witnesses: [
			...
			'triage-declared-type-hostonly', // ~1s
				'triage-type-of-symbol-hostonly', // ~1s
					...
					'triage-symbol-to-param-guard', // ~1s
					'triage-symbol-to-param-import-mode', // ~1s
					'triage-spell-memo', // ~1s
					'triage-program-reuse', // ~1s
					'triage-jsdoc-writable', // ~1s
					'triage-semantic-highlight-edit', // ~2s
			'triage-thistype-refguard', // ~1s (issues #69/#70)
